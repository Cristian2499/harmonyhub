  ...
  return (
      ...
      <div className="bg-card card m-1 py-1 px-4 border-0">
        ...
        <div className="d-flex">
          ...
          <div className="base-play bg-light d-flex justify-content-center align-items-center"><button className="btn-play"><i className="fa-solid fa-play fs-1"></i></button></div>
        </div>
        <div className="footer-card d-flex mt-2 text-white">
          <button className="btn-like me-1"><i className="fa-regular fa-heart"></i></button>

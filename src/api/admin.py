...
from .models import db, User, MusicGender, UserMusicGender, MusicRole, UserMusicRole, Song, TrackLikes, ConnectUsers
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(ConnectUsers, db.session))

...
const CardMyProfile = () => {
  return (
    ...
    <div className="card-body">
      ...
      <p>Hi, I'm a progressive electronic music producer seeking collaborators. Let's join forces to create unique, innovative tracks. Interested? Let's connect!</p>
    </div>
  </div>

...
export const Home = () => {
	...
	return (
		...
		<div className="container-fluid d-flex row justify-content-center align-items-center m-0">
		<div className="container d-flex justify-content-center my-2 py-2"><h2>Discover New Artists</h2></div>
		<CardNewArtist name="John Doe - Guitarist" imageNewArtist={img01}/>
		<CardNewArtist name="Jane Smith - Singer" imageNewArtist={img02}/>
		<CardNewArtist name="Mike Johnson - M. Producer" imageNewArtist={img03}/>
		<CardNewArtist name="Emily Davis - Guitarist" imageNewArtist={img04}/>
		<CardNewArtist name="Chris Lee - Cellist" imageNewArtist={img05}/>
		<CardNewArtist name="Anna Brown - M. Producer" imageNewArtist={img06}/>
		</div>
		<Footer />
		</div>
		</div>
